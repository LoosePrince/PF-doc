...
- 自定义风格储存路径，可参考[功能列表 - 风格详细说明](PF-gugubot/功能列表.md#风格详细说明)
...
A：[GUGUbot 疑难解答#2](常见问题/GUGUbot-疑难解答.md#关于-mc--群内-转发时玩家id包裹方式不一)

Q：如何启用RCON  
A：[GUGUbot 疑难解答#3](常见问题/GUGUbot-疑难解答.md#如何配置rcon如何连接到rcon提示-开启rcon以显示结果-怎么办)
